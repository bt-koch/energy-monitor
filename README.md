...
The app is hosted on the open data show room of the University of Bern: [Energie-Monitor Basel-Stadt](https://energie-monitor-basel-stadt.opendata.iwi.unibe.ch/#)
